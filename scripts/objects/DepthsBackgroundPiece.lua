...
---@class DepthsBackgroundPiece : Object
---@overload fun(...) : DepthsBackgroundPiece
local DepthsBackgroundPiece, super = Class(Object)

function DepthsBackgroundPiece:init(sprite, x, y)
...
function DepthsBackgroundPiece:canDebugSelect()
    return false
end

function DepthsBackgroundPiece:update()
...
function DepthsBackgroundPiece:draw()
    super.draw(self)
