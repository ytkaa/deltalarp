local inflamedkipkipflame, super = Class(Bullet)

function inflamedkipkipflame:init(x, y)
    super.init(self, x, y, "bullets/inflamedkipkip/flame")
    self.timer = 0
end

function inflamedkipkipflame:update()
    super.update(self)
