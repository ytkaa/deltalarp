---@class FloweryLongLeg2 : Bullet
local FloweryLongLeg2, super = Class(Bullet)
...
function FloweryLongLeg2:init(x, y, dir, speed)
...
function FloweryLongLeg2:update()
    if self.timer then
        self.timer:update()
        if self.moving then
