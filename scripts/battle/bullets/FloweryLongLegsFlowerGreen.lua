---@class FloweryLongLegsFlowerGreen : Bullet
local FloweryLongLegsFlowerGreen, super = Class(Bullet)
...
function FloweryLongLegsFlowerGreen:update()
    ...
    if self.shoot_timer >= 3.5 then
        ...
        if self.wave then
            ...
            local pellet5 = self.wave:spawnBullet("pelletGreen", self.x, self.y)
...
return FloweryLongLegsFlowerGreen
