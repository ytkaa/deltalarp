return {
    ...
    test_school = function(cutscene)
        ...
        if start == 1 then
            ...
            Game.world.music:play("class1")
            cutscene:setSprite(handle, "handle_up")
            cutscene:wait(3)
            cutscene:setSpeaker(yoori)
            cutscene:text("* I love books.")
            ...
            cutscene:text("* Your sneaks are nice [color:yellow]and[color:reset] original    .")
            cutscene:setSpeaker(tundra)
            ...
            cutscene:setSpeaker(yoori)
            cutscene:text("[next]* I love reading books![wait:5] \nEspecially the")
            cutscene:setSpeaker(glaggle)
            ...
            cutscene:setSprite(handle, "handle_right")
            cutscene:setSpeaker(handle)
            cutscene:text("* (Haha),[wait:5] I sure do![wait:5] My man!")
            cutscene:setSpeaker(walrus)
            cutscene:text("* Yeah,[wait:5] man.")
            cutscene:setSprite(handle, "handle_up")
            cutscene:setSpeaker(glaggle)
