return {
    grace_intro = function(cutscene, event)
        ...
        cutscene:wait(cutscene:text("* Guess that's why there's been less food for[wait:5] me[wait:3] recently...", options))
        ...
        cutscene:wait(cutscene:text("* Of COURSE it would be YOUR fault I've had to...[wait:5] to...", options))
        music:stop()
        ...
        cutscene:wait(cutscene:text("* I don't need you stealing more of my food..."))
        cutscene:text("* ...food that I found fair and $$$$ing square.")
