return {
    ...
    ofer_intro = function(cutscene, event)
        ...
        cutscene:text("[face:angry, -19, -13]* (...[wait:5]I have to..!)")
        Game.world.music:play("grace", 1)
        sofer.sprite.anim_speed = 3
        cutscene:wait(2)
        ...
        cutscene:text("[face:consider, -19, -13]* You can just,[wait:5] uhhh,[wait:5] \nchill with...[wait:5] me.")
        cutscene:text("[face:kawaii, -19, -13]* And we can do painting \nand rock music and \nwhatever else you want !")
        cutscene:text("[face:kawaii, -19, -13]* Because...")
        cutscene:text("[face:nervous, -19, -13]* Uhhh...")
        cutscene:text("[face:kawaii_grin, -19, -13]* Uh...[wait:5] CLEARLY what YOU \nwant is way cooler \nthan...")
    ...
    grace_sofer1 = function(cutscene, event)
        ...
        speak(grace, "[face:brow, -19, -13]* It's cool just,[wait:5] like,[wait:5]\nuhhh...")
        speak(grace, "[face:sad_brow_smile, -19, -13]* Making a friend.[wait:5] \nLike you.")
        speak(grace, "[face:sad_brow, -19, -13]* Feels kinda...[wait:5] hard.[wait:5]\nSometimes.")
        speak(grace, "[face:sad_brow_smile, -19, -13]* Hah,[wait:5] y'know?")
        ...
        speak(grace, "[face:snark, -19, -13]* Yeah.[wait:5] We should,[wait:5] like,\n[wait:5]stage an intervention!")
        ...
        speak(sofer, "* It is !!!")
        speak(grace, "[face:sus, -19, -13]* But,[wait:5] hey,[wait:5] that gray \nperson might be with him,[wait:5]\nand I don't want to...")
        sofer.sprite.anim_speed = 2
        speak(sofer, "* WE can beat THEM up too !!!")
        speak(grace, "[face:nervous, -19, -13]* HEY,[wait:5] uhh,[wait:5] like,[wait:5] maybe we\ntry talking Tofer out of\nbeing...")
        speak(grace, "[face:consider, -19, -13]* ...[wait:5]uhh,[wait:5] like this.")
        speak(grace, "[face:brow, -19, -13]* Let's try that...[wait:5] first.")
        ...
        speak(tofer, "[face:emotion, -19, -13]* ...[wait:5]heh.")
    ...
    treasureHuntBegin = function(cutscene)
        if treasureHuntBegan == false then
            cutscene:detachFollowers()
            cutscene:detachCamera()
            local tofer = cutscene:getCharacter("tofer")
            local vess = cutscene:getCharacter("vess")
            ...
            cutscene:setSpeaker(tofer)
            cutscene:setAnimation(tofer, "cycle")
            cutscene:text("[face:tofer, -19, -13]* Heh! [wait:5]Check it[sound:tofer_checkit],[wait:5] gray \nbrolio!")
            cutscene:text("[face:tofer, -19, -13]* I think this [color:red]little guy[color:reset] \nwants to say something!")
            cutscene:text("[face:tofer, -19, -13]* Luckily's,[wait:5] as a carrot,\n[wait:5]I can speak.[wait:5] This guy's \nlanguage!")
            cutscene:setSpeaker(nil)
            cutscene:text("* Yen ho![wait:5] Hop he me!")
            cutscene:setSpeaker(tofer)
            cutscene:text("[face:tofer, -19, -13]* Heh![wait:5] This guy says he \nneeds my help!")
            cutscene:text("[face:tofer, -19, -13]* Because he thinks only \nI have what it takes!")
            cutscene:text("[face:tofer, -19, -13]* Heh![wait:5] Guess the people \nreally do love me...")
            cutscene:setSpeaker(nil)
            cutscene:text("* That's not what I said.")
            cutscene:setSpeaker(tofer)
            cutscene:text("[face:emotioner, -19, -13]* What?[wait:5] You can speak \nEnglish?")
            cutscene:setSpeaker(nil)
            cutscene:text("* No just these two sentences and like four others")
            cutscene:text("* Hep hep ho!")
            cutscene:setSpeaker(tofer)
            cutscene:text("[face:tofer, -19, -13]* Heh![wait:5] Well!")
            cutscene:text("[face:tofer, -19, -13]* This guy says he wants \nus to collect [color:yellow]TREASURE[color:reset]!")
            cutscene:text("[face:tofer, -19, -13]* Only then will they \nlet us [color:yellow]THROUGH[color:reset]!")
            cutscene:text("[face:tofer, -19, -13]* Can do,[wait:5] brolio!")
            cutscene:setSpeaker(nil)
            cutscene:text("* Min hen go![wait:5] Le hey!")
            cutscene:setSpeaker(tofer)
            cutscene:text("[face:tofer, -19, -13]* What?[wait:5] SOFER said she \nstill loves me,[wait:5] her \nbig broseph?")
            cutscene:text("[face:tofer, -19, -13]* Woah,[wait:5] brolio.[wait:5] SOFER\nreally is such a \nsweet lil sis![wait:5] Heh.")
            cutscene:setSpeaker(nil)
            cutscene:text("* Okay stop.[wait:5] Tofer please translate what I'm saying properly.")
            cutscene:text("* If you don't do that then all of us are going to beat you to death.[wait:5] Tofer.")
            cutscene:setSpeaker(tofer)
            cutscene:text("[face:tofer, -19, -13]* Heh.[wait:5] Okay,[wait:5] brolio!")
            cutscene:setSpeaker(nil)
            cutscene:text("* ([voice:none][noskip][sound:cd_bagel/noelle]Tofer will now translate properly!)")
            cutscene:setSpeaker(nil)
            cutscene:text("* Thanks.[wait:5] Please talk to me again when you're ready.")
            cutscene:attachFollowers()
            cutscene:attachCamera()
