return {
    ...
    treasureHuntBegin = function(cutscene)
        ...
        local camera = Game.world.camera
        cutscene:slideTo(tofer, "toferpos", 1.5)
        cutscene:slideTo(vess, "vesspos", 1.5)
        cutscene:setAnimation(tofer, "cycle")
        cutscene:setAnimation(vess, "right")
        cutscene:wait(cutscene:panTo(kipkip.x, kipkip.y, 1.5))
        cutscene:look("vess", "up")
        cutscene:text("* Yeho!! Mi yen! Hop hup ye!")
        cutscene:setSpeaker(tofer)
        cutscene:setAnimation(tofer, "cycle")
        cutscene:text("[face:tofer, -19, -13]* Heh! [wait:5]Hold on,[wait:5] gray \nbrolio!")
        cutscene:text("[face:tofer, -19, -13]* I think this little guy \nwants to say something!")
        cutscene:text("[face:tofer, -19, -13]* Thankfully,[wait:5] as a carrot,\n[wait:5]I can speak this guy's \nlanguage.")
        cutscene:setSpeaker(nil)
        cutscene:text("* Yen ho! Hop he me!")
        cutscene:setSpeaker(tofer)
        cutscene:text("[face:tofer, -19, -13]* Wow![wait:5] This guy says he \nneeds my help!")
        cutscene:text("[face:tofer, -19, -13]* Because he thinks only I \ncan do it!")
        cutscene:text("[face:tofer, -19, -13]* Heh![wait:5] Guess the people \nreally do love me...")
        cutscene:setSpeaker(nil)
        cutscene:text("* That's not what I said.")
        cutscene:setSpeaker(tofer)
        cutscene:text("[face:emotioner, -19, -13]* Huh?[wait:5] You can speak \nEnglish?")
        cutscene:setSpeaker(nil)
        cutscene:text("* No just these two sentences and like four others")
        cutscene:text("* Hep hep ho!")
        cutscene:setSpeaker(tofer)
        cutscene:text("[face:tofer, -19, -13]* Ah![wait:5] Welph!")
        cutscene:text("[face:tofer, -19, -13]* This guy says he wants \nus to collect [color:yellow]TREASURE!")
        cutscene:text("[face:tofer, -19, -13]* Only then will they \nlet us [color:yellow]THROUGH!")
        cutscene:text("[face:tofer, -19, -13]* Can do,[wait:5] brolio!")
        cutscene:setSpeaker(nil)
        cutscene:text("* Min hen go! Le hey!")
        cutscene:setSpeaker(tofer)
        cutscene:text("[face:tofer, -19, -13]* Huh?[wait:5] Sofer said she \nstill loves me, her \nbig bro?")
        cutscene:text("[face:tofer, -19, -13]* Wow,[wait:5] brolio.[wait:5] Sofer\nreally is such a \nsweet lil sis!")
        cutscene:setSpeaker(nil)
        cutscene:text("* Okay stop.[wait:5] Please translate what I'm saying properly.")
        cutscene:text("* If you don't do that then all of us are going to beat you to death.")
        cutscene:setSpeaker(tofer)
        cutscene:text("[face:emotion, -19, -13]* Okay.")
        cutscene:setSpeaker(nil)
        cutscene:text("* ([voice:none][noskip][sound:cd_bagel/noelle]Tofer will now translate properly!)")
        cutscene:setSpeaker(nil)
        cutscene:text("* Thanks. Please talk to me again when you're ready.")
        cutscene:attachFollowers()
        cutscene:attachCamera()
